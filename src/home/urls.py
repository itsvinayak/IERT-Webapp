...
urlpatterns = [
    ...
    path(
        "Computer_science_and_engg",
        views.Computer_science_and_engg,
        name="Computer_science_and_engg",
    ),
    path("Electronics_engg", views.Electronics_engg, name="Electronics_engg"),
    path(
        "Industrial_&_production_engg",
        views.Industrial_and_production_engg,
        name="Industrial_&_production_engg",
    ),
    path(
        "Instrumentation_&_Control_Engg",
        views.Instrumentation_and_Control_Engg,
        name="Instrumentation_&_Control_Engg",
    ),
    ...
    path(
        "Applied_science_and_humanity",
        views.Applied_science_and_humanity,
        name="Applied_science_and_humanity",
    ),
