...
def contact_us(request):
    ...
    page_details = {"title": "Contact Us", "form": form}
...
def Civil_Engg(request):
    ...
    bd = {"title": "Civil Engg", "notice": notices, "teacher": teacher, "bra": bra}
    return render(request, "home/degree_division.html", bd)
...
def Electrical_Engg(request):
    ...
    bd = {"title": "Electrical Engg", "notice": notices, "teacher": teacher, "bra": bra}
    return render(request, "home/degree_division.html", bd)
...
def Mechanical_engg(request):
    ...
    bd = {"title": "Mechanical engg", "notice": notices, "teacher": teacher, "bra": bra}
    return render(request, "home/degree_division.html", bd)
...
def Management(request):
    ...
    bd = {"title": "Management", "notice": notices, "teacher": teacher, "bra": bra}
    return render(request, "home/degree_division.html", bd)
