...
class User_detailsForm(forms.ModelForm):
    ...
    branch = forms.CharField(max_length=400, label='select your branch',
                             widget=forms.Select(choices=branch_list), required=False)
    roll_no = forms.CharField(max_length=30, required=False)
    year = forms.CharField(max_length=5, label='select your year',
                           widget=forms.Select(choices=year_list), required=False)
